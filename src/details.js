const details = [
    ...
    },
    {
        ...
        rules: ["- Entry fee Rs.50 per Team.","- Registration can be done through both online and offline .","- Spot Registration should be done 15 mins before the event begins.","-Time Required : 1 hr","- No of members per team:2","- Event include Two Rounds (Memorize & Connections)","- Preliminary Round : Memorize","- Final Round : Connections","Memorize:","- Picture will be displayed for 5 seconds, questions will be asked from that.","- 5-10 questions.       ( depends on no. of participants).","- Top teams will be selected for connections.","Connections:","- Questions from Movies and Sports.","- Questions asked on 3 levels (Easy, Medium , Hard)","    . Easy > 1 Point","    . Medium > 1.5 Points","    . Hard > 2 Points","- Time limit :","    Easy : 10sec","    Medium : 12sec","    Hard : 15sec","- Top 2 teams will be awarded."],
